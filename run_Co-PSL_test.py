...
for test_ins in ins_list:
    ...
    suffix=f"_Co-PSL_DGEMO_220_40_5"
    suffix_dir = ""
    ...
    x_init = np.load(f"warmup_evaluation/DGEMO_{test_ins}_X_{n_dim}_220_5.npy")
    y_init = np.load(f"warmup_evaluation/DGEMO_{test_ins}_Y_{n_dim}_220_5.npy")
